...
void GameState::initTextures()
{
	...
	textures["BOMB_SHEET"].loadFromFile("Resources/Images/Player_Spritesheet/Bomb_Sheet.png");
	textures["EXPLOSION_SHEET_VERTICAL"].loadFromFile("Resources/Images/Player_Spritesheet/Explosion_Sheet_Vertical.png");
	textures["EXPLOSION_SHEET_HORIZONTAL"].loadFromFile("Resources/Images/Player_Spritesheet/Explosion_Sheet_Horizontal.png");
}
...
{
	player = new Player(135, 135, textures["PLAYER_SHEET"]);
	player2 = new Player(1555, 135, textures["PLAYER_SHEET"]);
}
...
void GameState::initObstacles()
{
	...
	while (std::getline(file, line, '.')) {
		...
		char comma;
		if (!(iss >> x >> comma >> y)) {
			std::cout << "B³¹d odczytu danych!" << std::endl;
			continue;
		}
